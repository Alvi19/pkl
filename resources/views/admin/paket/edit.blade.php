    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col card-wrapper">
                <div class="card">
                    <div class="card-body">
                        <h1 style="text-align: center">Edit Paket</h1>
                        ...
                        <form action="{{ route('paket.update', [$data->id]) }}" method="POST">
                                ...
                                <select class="form-control form-control-sm" name="produk_id" id="produk_id"
                                    ...
                                    @foreach ($produks as $produk)
                                        <option value="{{ $produk->id }}"
                                            {{ $produk->id == $data->produk_id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control summernote" rows="5" name="judul_paket" placeholder="Judul Kaket">{{ $data->judul_paket }}</textarea>
                            </div>
                            <div class="mb-3">
